...
const AppVerticalNavExpansionPannel = ({ item, children, mode }) => {
  ...
  const handleClick = () => {
    ...
    // console.log("🚀 ~ file: MatxVerticalNavExpansionPanel.jsx:89 ~ handleClick ~ elementRef.current:", elementRef.current)
  };

  const calcaulateHeight = useCallback((node) => {
    if (node.name !== 'child') {
      for (let child of node.children) {
        // console.log("🚀 ~ file: MatxVerticalNavExpansionPanel.jsx:94 ~ calcaulateHeight ~ child:", child)
...
export default AppVerticalNavExpansionPannel;
