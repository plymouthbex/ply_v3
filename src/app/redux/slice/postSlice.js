...
export const UpdateSeqPriceList = createAsyncThunk(
  "post/UpdateSeqPriceList", // Action type string
  async ({ data }, { rejectWithValue }) => {
    try {
      const URL = `${process.env.REACT_APP_BASE_URL}PriceList/UpdatePriceListSequence `;
      const response = await axios.put(URL, data, {
        headers: {
          Authorization: process.env.REACT_APP_API_TOKEN,
          "Content-Type": "application/json",
...
export const CustomerConfig = createAsyncThunk(
  "post/CustomerConfig", // Action type string
  async (data, { rejectWithValue }) => {
    try {
      const URL = `${process.env.REACT_APP_BASE_URL}GPRungroup/CustomerConfig`;
      const response = await axios.put(URL, data, {
        headers: {
          Authorization: process.env.REACT_APP_API_TOKEN,
          "Content-Type": "application/json",
