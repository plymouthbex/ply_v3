...
const PriceSheet = Loadable(lazy(() => import('./price-sheet/PriceSheet')));
const PriceSheetEdit = Loadable(lazy(() => import('./price-sheet/PriceSheetEdit')));
...
const ConfigureSJCustomerEdit=Loadable(lazy(() => import('./Customer/Configure/configureSJEdit')));
...
const controlPanelRoutes = [
  ...
  { path: '/pages/control-panel/price-sheet', element: <PriceSheet /> },
  { path: '/pages/control-panel/price-sheet/price-sheet-detail/:mode', element: <PriceSheetEdit /> },
  ...
  { path: '/pages/control-panel/configure-price-book/customer/:mode/configureSJEdit', element: <ConfigureSJCustomerEdit /> },
